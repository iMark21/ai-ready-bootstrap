...
| SH-F4-104 | Install: stack detection via `--stack` flag + stack-specific glob defaults | done | `acceptance/SH-F4-104-105-install-helpers.feature` | beta |
| SH-F4-105 | Install: migrate a README `## TODO`/`## Roadmap` checklist into BACKLOG.md rows | done | `acceptance/SH-F4-104-105-install-helpers.feature` | beta |
...
| SH-F4-113 | Public-readiness fixup: CI badge branch reference (develop → main) | todo | `specs/SH-F4-113-ci-badge-fix.md` / `acceptance/SH-F4-113-ci-badge-fix.feature` | beta |
