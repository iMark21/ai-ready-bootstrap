...
| **Code globs** | The path patterns declared in `.ai/hooks/config.sh` that the pre-commit hook treats as "feature code requiring a spec touch". Per-project tunable. |
