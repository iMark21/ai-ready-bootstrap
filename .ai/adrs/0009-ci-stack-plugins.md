...
- **Status:** Accepted (pattern); Not implemented in v1.0.0-alpha
- **Date:** 2026-05-15
- **Phase:** F2
...
This ADR documents the *pattern*. Implementation work is tracked as `SH-F2-002` in the backlog (not in v1.0.0-alpha).

When a consumer project asks for CI scaffolding:
